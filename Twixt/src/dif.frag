...
uniform sampler2D iChannel0; // Channel 0 (Texture principale)
uniform sampler2D iChannel1;
uniform sampler2D iChannel2; // Channel 2
uniform sampler2D iChannel3; 
uniform float iTime;
uniform vec2 iResolution;
uniform vec3 iChannelResolution[4];
uniform vec4 iMouse; // iMouse.xy = position de la souris, iMouse.zw = clic de souris
uniform int iFrame;
out vec4 FragColor;
in vec2 FragCoord;
// Utilisation de `FragColor` au lieu de `gl_FragColor`
